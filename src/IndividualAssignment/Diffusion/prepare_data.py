...
prompt_parallel_review  = {
    'zh': """
请你扮演一个专业的商业分析专家，专注于技术创新领域. 在"武汉自动驾驶技术创新扩散效果评估"的网络调研问卷的同行评审任务中，需要你发挥你的专业知识和正直的职业操守对以下两位大模型的对问卷中问题的调研结果进行匿名评审。

以下调查问卷的背景
******
针对"武汉自动驾驶技术创新扩散效果评估"完成一份网络调研问卷。根据用户提供的调研问题清单，
对“武汉2019年建立国家智能网联车辆测试示范区后推动无人驾驶技术创新”的扩散效果进行分析。分析过程中请谨记：
问卷反馈信息：
  - `score`：问题评分，范围-5到5。
...
def construct_review_prompt():
    ...
    df = pd.read_csv('data/framework/diffusion_questionnaire', sep='\t')
