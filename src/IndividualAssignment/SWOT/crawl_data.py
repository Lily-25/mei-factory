...
prompt_extraction_keyword = {
    'zh': """角色：你是一位严谨的商业分析专家，专注于技术创新领域。现在需要你针对"龙灵山生态公园自动驾驶主题景区项目"完成一份网络调研问卷。

任务：根据用户提供的调研问题清单，对“龙灵山生态公园2020年引入无人驾驶技术创新”后续发展进行分析。分析过程中请谨记：
...
if __name__ == '__main__':
    file_path = 'IndividualAssignment/SWOT/data/framework/Introduce_innovation.csv'
